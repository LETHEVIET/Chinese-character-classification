...
class SqueezeNet(nn.Module):
    ...
    def __init__(self, class_num=100):
        ...
        self.clpx_con1 = nn.Conv2d(64, int(128), 1)
        self.fire3 = Fire(128, 128, 16)
        self.fire4 = Fire(128, 256, 32)
        self.clpx_con2 = nn.Conv2d(128, int(256), 1)
        self.fire5 = Fire(256, 256, 32)
        self.fire6 = Fire(256, 384, 48)
        self.clpx_con3 = nn.Conv2d(256, int(384), 1)
        self.fire7 = Fire(384, 384, 48)
        self.fire8 = Fire(384, 512, 64)
        self.clpx_con4 = nn.Conv2d(384, int(512), 1)
    ...
    def forward(self, x):
        ...
        f2 = self.fire2(x) + self.clpx_con1(x)
        f3 = self.fire3(f2) + f2
        f3 = self.maxpool(f3)
        
        f4 = self.fire4(f3) + self.clpx_con2(f3)
        f5 = self.fire5(f4) + f4
        f5 = self.maxpool(f5)

        f6 = self.fire6(f5) + self.clpx_con3(f5)
        f7 = self.fire7(f6) + f6
        f8 = self.fire8(f7) + self.clpx_con4(f7)
        f9 = self.fire9(f8) + f8
        c10 = self.conv10(f9)
